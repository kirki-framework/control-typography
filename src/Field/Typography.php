			...
			Kirki::add_field(
				...
				wp_parse_args(
					[
						...
						'output'      => $this->get_subfield_output( $args, 'font-family' ),
					],
					$args
				)
			);
			...
			Kirki::add_field(
				...
				wp_parse_args(
					[
						...
						'output'      => $this->get_subfield_output( $args, 'font-style' ),
					],
					$args
				)
			);
			...
			Kirki::add_field(
				...
				wp_parse_args(
					[
						...
						'output'      => $this->get_subfield_output( $args, 'font-size' ),
					],
					$args
				)
			);
			...
			Kirki::add_field(
				...
				wp_parse_args(
					[
						...
						'output'      => $this->get_subfield_output( $args, 'line-height' ),
					],
					$args
				)
			);
			...
			Kirki::add_field(
				...
				wp_parse_args(
					[
						...
						'output'      => $this->get_subfield_output( $args, 'letter-spacing' ),
					],
					$args
				)
			);
			...
			Kirki::add_field(
				...
				wp_parse_args(
					[
						...
						'output'      => $this->get_subfield_output( $args, 'word-spacing' ),
					],
					$args
				)
			);
			...
			Kirki::add_field(
				...
				wp_parse_args(
					[
						...
						'output'      => $this->get_subfield_output( $args, 'text-transform' ),
					],
					$args
				)
			);
			...
			Kirki::add_field(
				...
				wp_parse_args(
					[
						...
						'output'      => $this->get_subfield_output( $args, 'text-decoration' ),
					],
					$args
				)
			);
			...
			Kirki::add_field(
				...
				wp_parse_args(
					[
						...
						'output'      => $this->get_subfield_output( $args, 'text-align' ),
					],
					$args
				)
			);
			...
			Kirki::add_field(
				...
				wp_parse_args(
					[
						...
						'output'      => $this->get_subfield_output( $args, 'margin-top' ),
					],
					$args
				)
			);
			...
			Kirki::add_field(
				...
				wp_parse_args(
					[
						...
						'output'      => $this->get_subfield_output( $args, 'margin-bottom' ),
					],
					$args
				)
			);
			...
			Kirki::add_field(
				...
				wp_parse_args(
					[
						...
						'output'      => $this->get_subfield_output( $args, 'color' ),
					],
					$args
				)
			);
	...
	public function get_subfield_output( $field, $property ) {
		...
		if ( isset( $field['output'] ) ) {
			foreach ( $field['output'] as $item ) {
				if ( isset( $item['choice'] ) && $property === $item['choice'] ) {
					$output[] = $item;
					continue;
				}
