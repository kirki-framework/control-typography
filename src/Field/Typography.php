			...
			new \Kirki\Field\Radio_Buttonset(
				wp_parse_args(
					[
						...
						'choices'     => [
							'none'      => '<span class="dashicons dashicons-no-alt"></span><span class="screen-reader-text">' . esc_html__( 'Inherit', 'kirki' ) . '</span>',
			...
			new \Kirki\Field\Radio_Buttonset(
				wp_parse_args(
					[
						...
						'choices'     => [
							'none'       => '<span title="' . esc_html__( 'None', 'kirki' ) . '"><span class="dashicons dashicons-no-alt"><span class="screen-reader-text">' . esc_html__( 'None', 'kirki' ) . '</span></span>',
			...
			new \Kirki\Field\Radio_Buttonset(
				wp_parse_args(
					[
						...
						'choices'     => [
							'initial' => '<span class="dashicons dashicons-no-alt"><span class="screen-reader-text">' . esc_html__( 'None', 'kirki' ) . '</span>',
